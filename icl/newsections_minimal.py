...
The above tutorial covers a lot of ground, but there are still some grammatical topics that are not covered. Add in any other sections that you think would be helpful. All sections you write should be succinct, describing the concept with one or two small tables of examples, and no unnecessary verbiage.
"""

with open("newsections_minimal.txt", "w") as f:
